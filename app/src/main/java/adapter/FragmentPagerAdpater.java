...
public class FragmentPagerAdpater extends PagerAdapter {
    ...
    public FragmentPagerAdpater(Context mContext, ArrayList<Contact> mContactArrayList) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        Contact lContact = mContactArrayList.get(position);
        ViewGroup item_view = (ViewGroup) lInflater.inflate(R.layout.activity_contact_information, container, false);
        ...
        mImg_url = lContact.getImg_url();
        mName = lContact.getName();
        mNumber = lContact.getNumber();
        mNumber_type = lContact.getNumber_type();
        mEmail = lContact.getEmail();
        mEmail_type = lContact.getEmail_type();
        mContactName.setText(mName);


        Glide.with(mContext).load(mImg_url).placeholder(R.drawable.profileplaceholder).into(mProfile_pic);
